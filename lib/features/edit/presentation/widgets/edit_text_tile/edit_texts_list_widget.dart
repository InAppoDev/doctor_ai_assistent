...
class EditTextsListWidget extends StatelessWidget {
  final List<TranscribedTextModel> list;
    ...
    return ColumnBuilder(
        ...
        itemBuilder: (context, index) {
          return ChangeNotifierProvider(
            create: (context) => EditTextProvider()..initData(context.read<EditState>().quillControllers[index], context.read<EditState>().transcribedTexts[index], null),
