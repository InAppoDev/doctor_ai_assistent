...
import 'package:doctor_ai_assistent/features/edit/presentation/widgets/edit_text_tile_buttons.dart';
...
class _EditTextTileState extends State<EditTextTile> {
  late EditProvider _editProvider;

  @override
  void initState() {
    super.initState();
    _editProvider = context.read<EditProvider>();
  }
