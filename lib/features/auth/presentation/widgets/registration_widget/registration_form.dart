...
class RegistrationFormWidget extends StatelessWidget {
  ...
  const RegistrationFormWidget(
      {super.key, required this.onSignInTap, required this.onRegisterTap});
      ...
      mobile: Column(
        children: [
          ...
          Consumer<RegisterState>(
            builder: (context, state, _) {
              return CustomTextFieldWidget(
                ...
                suffixIcon: IconButton(
                  icon: Icon(state.isPasswordConfirmationVisible
                      ? Icons.visibility
                      : Icons.visibility_off),
          ...
          PrimaryButton(
            ...
            textStyle:
                AppTextStyles.regularPx16.copyWith(color: AppColors.white),
          ...
          PrimaryButton(
            ...
            borderColor: AppColors.accentBlue,
            textStyle:
                AppTextStyles.regularPx16.copyWith(color: AppColors.accentBlue),
            padding: const EdgeInsets.symmetric(vertical: 12),
            onPress: () {
              onSignInTap();
            },
              ...
              Consumer<RegisterState>(builder: (context, state, _) {
                return Expanded(
                  ...
                  suffixIcon: IconButton(
                    ...
                    onPressed: () =>
                        state.togglePasswordConfirmationVisibility(),
                  ),
                  labelStyle: Responsive.isDesktop(context)
                      ? AppTextStyles.mediumPx16
                      : AppTextStyles.mediumPx14,
